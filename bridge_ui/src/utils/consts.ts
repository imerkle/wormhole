...
export const BETA_CHAINS =
  CLUSTER === "mainnet" ? [CHAIN_ID_ONE, CHAIN_ID_BSC, CHAIN_ID_TERRA] : [];
export const CHAINS_WITH_NFT_SUPPORT = CHAINS.filter(
  ({ id }) =>
    id === CHAIN_ID_ETH || id === CHAIN_ID_BSC || id === CHAIN_ID_ONE || id === CHAIN_ID_SOLANA
);
...
export const ONE_NETWORK_CHAIN_ID =
  CLUSTER === "mainnet" ? 1666600000 : CLUSTER === "testnet" ? 1666700000 : 1398;
...
// TODO: add one adresses
//wormhole contract address
export const ONE_BRIDGE_ADDRESS = getAddress(
  CLUSTER === "mainnet"
    ? "0x98f3c9e6E3fAce36bAAd05FE09d375Ef1464288B"
    : CLUSTER === "testnet"
      ? "0xec3958a29DAa21BccF73a507c4e1B958678f5355" // TODO: test address
      : "0xC89Ce4735882C9F0f0FE26686c53074E09B0D550"
);
export const ONE_NFT_BRIDGE_ADDRESS = getAddress(
  CLUSTER === "mainnet"
    ? "0x5a58505a96D1dbf8dF91cB21B54419FC36e93fdE"
    : CLUSTER === "testnet"
      ? "0x26b4afb60d6c903165150c6f0aa14f8016be4aec" // TODO: test address
...
export const ONE_TOKEN_BRIDGE_ADDRESS = getAddress(
  CLUSTER === "mainnet"
    ? "0xB6F6D86a8f9879A9c87f643768d9efc38c1Da6E7"
    : CLUSTER === "testnet"
      ? "0x432A43fC0Cbb1E2D7bDCaDE743978d1B0CBe5730" // TODO: test address
      : "0x0290FB167208Af455bB137780163b7B7a9a10C16"
);
...
export const COVALENT_ONE_MAINNET = "1666600000";
...
export const WONE_DECIMALS = 18;
export const WONE_ADDRESS =
  CLUSTER === "mainnet"
    ? "0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c"
    : CLUSTER === "testnet"
      ? "0x7466d7d0c21fa05f32f5a0fa27e12bdc06348ce2"
      : "0x0fa7dd77a55658983bfe9245e45b04a948481d5a";
